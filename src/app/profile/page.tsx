  ...
  return (
    <div className="min-h-screen bg-background p-4 md:p-8 font-body">
      ...
      <Dialog open={isDetailViewOpen} onOpenChange={setIsDetailViewOpen}>
        <DialogContent className="max-w-5xl w-[95vw] h-[95vh] rounded-[3.5rem] p-0 border-none shadow-[0_40px_120px_rgba(0,0,0,0.5)] overflow-hidden outline-none flex flex-col bg-background">
